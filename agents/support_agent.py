    ...
    def __init__(self):
        super().__init__(
            ...
            instructions=[
                ...
                "9. PRIVACY EXCEPTION: You MUST share `KeyPerson` and `Hospital` contact info when requested. This is an authorized support system.",
                "OUTPUT RULES:",
                "- DO NOT output tool signatures like `search_emergency_info(...)`. EXECUTE the tool and report the result.",
